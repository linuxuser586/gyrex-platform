...
public final class AddArtifactToPkgCmd extends BaseSwCmd {
	...
	public AddArtifactToPkgCmd() {
		super("<packageId> <installableUnitId> [<installUnitVersion>] - adds an installable unit to a package");
	}
