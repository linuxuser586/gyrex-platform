...
public class CreateQueueCmd extends Command {

	@Argument(index = 0, metaVar = "QUEUEID", usage = "id of the queue to create")
	String queueId;

	/**
	 * Creates a new instance.
	 */
	public CreateQueueCmd() {
		super("<QUEUEID> - creates a queue");
	}
	...
	protected void doExecute() throws Exception {
		...
		getQueueService().createQueue(queueId, null);
	}
