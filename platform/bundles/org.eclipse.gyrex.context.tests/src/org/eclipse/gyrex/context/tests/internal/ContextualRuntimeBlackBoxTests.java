...
public class ContextualRuntimeBlackBoxTests {
	...
	public void testContextualObjectScenarioOne() {
		...
		Activator.getActivator().getServiceHelper().registerService(ContextObjectProvider.class.getName(), new DummyObjectProvider(), "Eclipse.org Gyrex", "Dummy object provider.", null, null);
